...
const blogListData = [
  {
    image: "https://preview.colorlib.com/theme/liquorstore/images/image_1.jpg.webp",
    date: "23 April 2020",
  ...
  {
    image: "https://preview.colorlib.com/theme/liquorstore/images/image_2.jpg.webp",
    date: "23 April 2020",
    title: "The Recipe from a Winemaker’s Restaurent",
    description:
      "A small river named Duden flows by their place and supplies it with the necessary regelialia.",
  ...
  {
    image: "https://preview.colorlib.com/theme/liquorstore/images/image_3.jpg.webp",
    date: "23 April 2020",
    title: "The Recipe from a Winemaker’s Restaurent",
    description:
      "A small river named Duden flows by their place and supplies it with the necessary regelialia.",
  ...
  {
    image: "https://preview.colorlib.com/theme/liquorstore/images/image_4.jpg.webp",
    date: "23 April 2020",
    title: "The Recipe from a Winemaker’s Restaurent",
    description:
      "A small river named Duden flows by their place and supplies it with the necessary regelialia.",
    ...
    <main>
      ...
      <section className="py-[60px] relative">
        <div className="max-w-[960px] px-[15px] flex justify-center items-center m-auto">
          <div className="h-[680px] w-[100%] flex flex-wrap bg-about-image bg-cover bg-no-repeat bg-center "></div>
      ...
      <section className="py-[60px] relative">
        <div className="max-w-[960px] px-[15px] m-auto animate-[fall_2s_ease_100ms]">
          ...
          {blogListData.map((listItem, index) => (
            <div key={index} className="flex flex-wrap">
              <div className="flex flex-row flex-[0_0_50%]">
                <div className="mb-[30px] flex">
                  <img
                    src={listItem.image}
                    alt={listItem.title}
                    className="w-[50%] h-[390px]"
                  />
                  <div className="w-[50%] bg-[#f5f4f0] p-[15px]">
                    <p className="mb-[10px]">
                      <span className="pr-[10px] text-gray">
                        {listItem.date}
                      </span>
                    </p>
