...
const LandingContent: React.FC<LandingContentProps> = ({
  ...
  return (
    <>
      <h1 className="textStroke absolute top-1/3 lg:top-1/2 left-1/2 -translate-x-1/2 lg:translate-x-0 lg:-translate-y-1/3 lg:left-[30px] -translate-y-1/2 text-[25px] sm:text-[40px] md:text-[60px] lg:text-[90px] leading-tight font-bold italic">
        <div className="rotate-[-4deg] text-center w-[300px] sm:w-[300px] md:w-[400px] lg:w-[560px] m-auto ">
          {t("slogan.good")}{" "}
