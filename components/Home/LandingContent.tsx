...
const LandingContent: React.FC<LandingContentProps> = ({
  ...
  return (
    <>
      <h1 className="textStroke absolute top-1/3 md:top-1/2 left-1/2 -translate-x-1/2 md:translate-x-0 sm:left-[30px] -translate-y-1/2 text-[25px] sm:text-[45px] md:text-[60px] lg:text-[90px] leading-tight font-bold italic">
