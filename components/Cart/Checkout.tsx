    ...
    <div className="border border-red p-8 rounded">
      ...
      <div>
        ...
        <p className="flex justify-between">
          <span className="text-[16px]">{tCart("subtotal")}</span>
          <span className="text-[16px]">${subtotal}</span>
        </p>
        <p className="flex justify-between">
          <span className="text-[16px]"> {tCart("delivery")}</span>
          <span className="text-[16px]">$0.00</span>
        </p>
        <p className="flex justify-between mb-4">
          <span className="text-[16px]">{tCart("discount")}</span>
          <span className="text-[16px]">$0.00</span>
        </p>
        <hr className="text-red" />
        <p className="flex justify-between p-4">
          <span className="text-[16px]">{tCart("total2")}</span>
