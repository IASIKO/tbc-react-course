...
import uploadImage from "../../../public/Assets/images/upload.png";
import { useRef, useState } from "react";
import { useTranslations } from "next-intl";
import { PutBlobResult } from "@vercel/blob";

interface AddBlogAvatarProps {
  blob: PutBlobResult | null;
  setBlob: (blob: PutBlobResult | null) => void;
}

const AddBlogAvatar: React.FC<AddBlogAvatarProps> = ({ blob, setBlob }) => {
