...
import { Blog, BlogInfo } from "../../types/blogs.type";
...
const EditBlogPage = ({ blogInfo }: { blogInfo: BlogInfo }) => {
    const [blog, setBlog] = useState<Blog>({
        ...
        given_name: blogInfo.given_name.length ? blogInfo.given_name : blogInfo.email,
      ...
      const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
        ...
        await editBlogAction(blog, blogInfo.id);
        router.push("/blog");
        setLoading(false);
      };
